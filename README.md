# Тестовое на позицию стажера-фронтендера в команду Seller Experience

### Задача: разработать интерфейс для сайта [Hacker News](https://news.ycombinator.com/news), состоящий из двух страниц..
